    ...
    return(
        <section id="TarjetaDescuento" className='animate__animated animate__fadeInDown animate__fast pt-6'>
            ...
            <div className="flex flex-wrap justify-center gap-5 p-5 mb-5">
                <div className='w-96 font-sans text-gray-500 leading-relaxed text-inherit antialiased'>
                    <p className=''>Pedi tu tarjeta de descuento para poder acceder a increibles beneficios en los locales adheridos</p>
