    ...
    return(
        <section id="QuienesSomos" className='py-5 animate__animated animate__fadeInDown animate__fast pt-6 flex flex-wrap gap-5 justify-center'>
            <div className="w-96 p-1">
                <h2 className="text-gray-600 font-bold text-center text-lg mb-5 px-2">Banco de apuntes</h2>
                ...
                <p className='text-gray-400 text-xs p-2'>Podes mandarnos tus apuntes a <a className="font-bold text-unahur-blue hover:unahur-blue-dark" href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSGLrTFtjTfjjBcPLltZssghcCzLbbplsFbdSPmvCTqNZfDGbBZHnvwjqLZjcLdStFXbBzlb" target="_blank">inquebrantables.unahur@gmail.com</a></p>
